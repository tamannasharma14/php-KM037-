...
<div>
    ...
    <center><span><h1 style="text-shadow: 0 0 3px #FF0000, 0 0 5px #0000FF; background-color:yellow">Fast & Furious 9</h1></span></center>
    <span><h3>Select Movie Hall and Timing:</h3></span>
    
    <hr>
        <div style="align:left;float: left; ">
            <img src="IMG/Capture.png" width="500px" height="100px">
          </div> 
...
<br><br>		
    ...
    <hr>
        <div style="align:left;float: left; ">
            <img src="IMG/Capture2.png" width="500px" height="100px">
          </div> 
		  <div style="align:left ">
		  <br>
		  <br>
...
<br><br>		
    ...
    <hr>
        <div style="align:left;float: left; ">
            <img src="IMG/Capture3.png" width="500px" height="100px">
          </div> 
		  <div style="align:left ">
		  <br>
		  <br>
