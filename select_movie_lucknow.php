...
<a href="#" class="a" style="font-size:20px;" ><b>GYT</b></a><a href="#" style="font-size:8px;">Get Your Ticket</a>
</div>
</div>
<div class="main">
<div class="container">
...
<li><a href="#">Home</a></li>
<li ><a class="dropdown-toggle" data-toggle="dropdown" href="#">Add New <span class="caret"></span></a>
	    <ul class="dropdown-menu">
       <li><a href="employee.php">Add New Empolyee</a></li>
       <li><a href="employee1.php">View Employee Details</a></li>
	    <li><a href="leaveadmin.php">View Leave Details</a></li>
      </ul>
	  </li>
<li><a href="passwordadmin.php">Change Password</a></li>
...
<div id="video" style="text-align:left ">
                <img src="IMG/FF.jpg" style="float:left;" width="500px" height="400px">
                       
                <div>  
                <video class="mySlides" width="847px" height="400px" controls autoplay>
                <source src="img/FF.mp4" type="video/mp4">
                </video>
                </div>
</div>
...
<div>
    ...
    <center><span><h1 style="text-shadow: 0 0 3px #FF0000, 0 0 5px #0000FF; background-color:gold">Fast & Furious 9</h1></span></center>
