...
<div id="video" style="text-align:left ">
                <img src="IMG/AM.jpg" style="float:left;" width="500px" height="400px">
                       
                <div>  
                <video class="mySlides" width="847px" height="400px" controls autoplay>
                <source src="img/AM.mp4" type="video/mp4">
                </video>
                </div>
</div>
...
<div>
    ...
    <center><span><h1 style="text-shadow: 0 0 3px #FF0000, 0 0 5px #0000FF; background-color:yellow">Angrezi Medium</h1></span></center>
    <span><h3>Select Movie Hall and Timing:</h3></span>
    
    <hr>
        <div style="align:left;float: left; ">
            <img src="IMG/Capture11.png" width="500px" height="100px">
          </div> 
...
<br><br>		
    ...
    <hr>
        <div style="align:left;float: left; ">
            <img src="IMG/Capture10.png" width="500px" height="100px">
          </div> 
		  <div style="align:left ">
		  <br>
		  <br>
...
<br><br>		
    ...
    <hr>
        <div style="align:left;float: left; ">
            <img src="IMG/Capture12.png" width="500px" height="100px">
          </div> 
		  <div style="align:left ">
		  <br>
		  <br>
