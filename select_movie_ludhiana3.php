...
<div>
    ...
    <hr>
        <div style="align:left;float: left; ">
            <img src="IMG/Capture13.png" width="500px" height="100px">
          </div> 
...
<br><br>		
    ...
    <hr>
        <div style="align:left;float: left; ">
            <img src="IMG/Capture14.png" width="500px" height="100px">
          </div> 
		  <div style="align:left ">
		  <br>
		  <br>
...
<br><br>		
    ...
    <hr>
        <div style="align:left;float: left; ">
            <img src="IMG/Capture15.png" width="500px" height="100px">
          </div> 
		  <div style="align:left ">
		  <br>
		  <br>
